...
export default function Header(props) {
  ...
  return (
    <Card className="header" interactive={true}>
      <div className="fill column">
        <ControlGroup className="row">
          <FormGroup className="name" label="Name">
            <InputGroup
          ...
          <FormGroup className="xp" label="Xp">
            <InputGroup type="number" value={xp} onChange={onChangeXp} />
          </FormGroup>
          <FormGroup className="level" label="Level">
            <InputGroup type="number" value={level} onChange={onChangeLevel} />
          </FormGroup>
        </ControlGroup>
        {isValidURL(image) ? (
          <img
          ...
          <NonIdealState
            ...
            action={
              <FormGroup label="Portrait" className="portrait-form-group">
                <InputGroup
                  fill={true}
